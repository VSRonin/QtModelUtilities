...
{
protected:
    void saveLoadByteArray(AbstractModelSerialiser* serialiser, const QAbstractItemModel *sourceModel, QAbstractItemModel *destinationModel, bool multiRole = true) const;
    void saveLoadFile(AbstractModelSerialiser* serialiser, const QAbstractItemModel *sourceModel, QAbstractItemModel *destinationModel, bool multiRole = true) const;
    void saveLoadString(AbstractStringSerialiser* serialiser, const QAbstractItemModel *sourceModel, QAbstractItemModel *destinationModel, bool multiRole = true) const;
